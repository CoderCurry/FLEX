...
- (void)viewDidLoad {
    ...
    accesoryToolViewHandleView.backgroundColor = [UIColor grayColor];
...
//    UIImageView *handleImageView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"dragicon.png"]];
